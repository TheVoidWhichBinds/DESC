...
parameter_plane_label_size = 18
cost_label_size = 16

parameter_plane_labelpad = -2
cost_labelpad = 2
...
output_file_1 = "Unconstrained.png"
output_file_2 = "Constrained.png"
...
def style_axes(
    ...
    ax.set_ylabel(
        "Parameter Plane",
        fontsize = parameter_plane_label_size,
        labelpad = parameter_plane_labelpad,
    )
    ax.set_zlabel(
        "Cost",
        fontsize = cost_label_size,
        labelpad = cost_labelpad,
    )
