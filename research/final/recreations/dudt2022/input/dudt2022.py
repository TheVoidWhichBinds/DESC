...
input_path = INPUT_DIR / "initial.h5"
output_path = OUTPUT_DIR / ("eq_" + name + "_CHECK.h5")
...
# EQ
#========================================================================================================================================
eq = Equilibrium.load(str(input_path))
...
if qs == "B":
    ...
    objective = ObjectiveFunction(
        QuasisymmetryFluxFunction(norm=True, helicity=(1, eq.NFP)),
        constraints,
    )

elif qs == "T":
    objective = ObjectiveFunction(
        QuasisymmetryTripleProduct(norm=True),
        constraints,
    )
